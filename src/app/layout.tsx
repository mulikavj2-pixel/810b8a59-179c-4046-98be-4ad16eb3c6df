...
export const metadata: Metadata = {
  title: "TechFlow - Modern Software Solutions for Enterprise",
  description: "Build scalable cloud-native applications with AI, web, and mobile development expertise. Trusted by 200+ companies.",
  keywords: "software development, cloud solutions, AI, machine learning, web development, startup technology",
  openGraph: {
    title: "TechFlow - Transform Your Tech Vision",
    description: "Enterprise software solutions for cloud, AI, and custom development.",
    siteName: "TechFlow",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "TechFlow - Modern Software Development",
    description: "Cloud-native, AI-powered, and scalable tech solutions."
  }
};
